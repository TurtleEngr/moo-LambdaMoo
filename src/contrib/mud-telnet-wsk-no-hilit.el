...
; RCS:          $Header: /repo/public.cvs/app/lambda/src/contrib/mud-telnet-wsk-no-hilit.el,v 1.1 2021/07/07 07:20:31 bruce Exp $
...
;;;                      in mud-send-kill-prefix 
;;;                    - added to page regexps
;;;		       - using the variable `baud-rate' instead of the
;;;		         obsolete function 
;;;                    - added code to popup the window in mud-check-page
;;;
  ...
  (let ((proc (get-buffer-process (current-buffer))))
    (cond ((or (null proc)
	  ...
	  (t
	   ...
	   (expand-abbrev)  ;; get expands on hitting RET -wsk
...
(defvar mud-input-history-size 50
