...
char rcsid_functions[] = "$Id: functions.c,v 1.3 2001/06/02 05:36:23 bruce Exp $";

/*
 * $Log: functions.c,v $
 * Revision 1.3  2001/06/02 05:36:23  bruce
 * Patch: ../patch/moo-1.8.0-FUP.patch
 *
 * Revision 1.2  2001/06/02 05:34:37  bruce
 * Patch: ../patch/moo-1.8.0-pAS5.patch
 *
